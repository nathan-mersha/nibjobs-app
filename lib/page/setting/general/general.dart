          ...
          children: [
            Expanded(
              ...
              child: ListView(itemExtent: 45, children: <Widget>[
                ...
                ListTile(
                  onTap: () {
                    makeWebCall("https://bit.ly/nibjobs_privacy_policy");
                  },
                  title: Text(
                    StringRsr.get(LanguageKey.PRIVACY_POLICY, firstCap: true)!,
                    style: Theme.of(context).textTheme.bodyText2!.copyWith(
                          fontWeight: FontWeight.bold,
                          fontSize: 17,
                        ),
                ...
                ListTile(
                  onTap: () {
                    makeWebCall("https://bit.ly/nibjobs_licence_and_agreement");
                  },
                  title: Text(
